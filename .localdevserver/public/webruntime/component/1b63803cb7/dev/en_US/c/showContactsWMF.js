Webruntime.moduleRegistry.define('c/showContactsWMF', ['lwc', 'lightning/configProvider', '@salesforce/apex/LWC_ContactController.getContactList'], function (lwc, configProvider, getContactList) { 'use strict';

    getContactList = getContactList && getContactList.hasOwnProperty('default') ? getContactList['default'] : getContactList;
    ...
    **/
    ...
    function tmpl$6($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        props: {
          "title": "Apex Wire Method To Function"
        },
        key: 2
        ...
        key: 4
      }, api_flatten([$cmp.contacts ? api_iterator($cmp.contacts, function (contact) {
        return api_element("p", {
          key: api_key(7, contact.Id)
        }, [api_dynamic(contact.Name), api_custom_element("lightning-formatted-email", _lightningFormattedEmail, {
          classMap: {
      ...
      }) : [], $cmp.error ? api_dynamic($cmp.error) : null, $cmp.error ? api_text(">") : null]))])])];
    }

    var _tmpl$7 = lwc.registerTemplate(tmpl$6);
    tmpl$6.stylesheets = [];
    tmpl$6.stylesheetTokens = {
      hostAttribute: "lwc-showContactsWMF_showContactsWMF-host",
      shadowAttribute: "lwc-showContactsWMF_showContactsWMF"
    };

    class ShowContactsWMF extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
    ...
    lwc.registerDecorators(ShowContactsWMF, {
      wire: {
        wiredContacts: {
    ...
    var showContactsWMF = lwc.registerComponent(ShowContactsWMF, {
      tmpl: _tmpl$7
    });

    return showContactsWMF;
